...
uint8_t 		u8SerialCtrl_TxData[] = {"hola mundo\n\r"};
...
void vfnSerialCtrl_Configure( void )
{
	...
	PIO_Configure( pPins, PIO_LISTSIZE( pPins ) );//1 dato

	PMC_EnablePeripheral(BASE_ID);
	
	/* Reset & disable receiver and transmitter, disable interrupts */
	UART_Configure(BASE_UART, UART_MR_PAR_NO, 9600, BOARD_MCK, vfnSerialCtrl_Transfer);
